...
import net.thedarkgamer.testmod.item.custom.SmartBlowTorchItem;
...
public class ModItems {
    ...
    //Misc
    public static final RegistryObject<Item> BLOW_TORCH = ITEMS.register("blow_torch", () -> new SmartBlowTorchItem(new Item.Properties().tab(ModCreativeModeTab.MAIN_TAB).durability(100)));
